...
import ethui from "./ethui.png";

[subvisual]: https://subvisual.com/
[thougthbot]: https://thoughtbot.com/
...
In fact, we at [Subvisual][subvisual] had this internal guideline (inspired by thoughtbot, I believe):
...
specifics were needed for this project. Things were suposed to just work. Did
...
We can do better than this. So let's

## My setup

This will be a collection of tools and scripts that I use whenever given the
chance, and that greatly speeds up feedback loops in ethereum applications. Fee
freel to jump around the list below instead of reading the whole thing.

Now, I'll also tell you right away, one of the main tools here is
[ethui][ethui], built by yours truly. This is not an ad though, just a rather
biased opinion.
