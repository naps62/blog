...
I've recently incorporated [dokploy][dokploy] into my homelab. It's quickly become one of my favorite open-source tools in my home server, due how polished it feels and how well it works. There was one particular service that I wanted to host that took some additional effort. Mainly because I needed it to be accessible via a wildcard subdomain (e.g. `*.mydomain.com`), to work as a multi-tenant app.
