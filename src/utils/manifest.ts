...
import * as customDoorbellApp from "../posts/2025-10-custom-doorbell-app-with-homeassistant/index.mdx";
...
const postEntries = [
  ...
  {
    slug: "custom-doorbell-app-with-homeassistant",
    dir: "2025-10-custom-doorbell-app-with-homeassistant",
    module: customDoorbellApp,
  },
] as const;
