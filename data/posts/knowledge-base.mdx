...
![notion index](/static/images/posts/knowledge-base/notion-index.png)

And within those pages, I can use a markdown-like syntax to list highlights:

![notion systems](/static/images/posts/knowledge-base/notion-thinking-systems.png)
...
![zk in action](/static/images/posts/knowledge-base/zk-in-action.gif)
